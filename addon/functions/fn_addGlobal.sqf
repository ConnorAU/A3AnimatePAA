...
params [["_target","",[objNull,""]],["_parameters","",["",[]]]];
if (_target in [objNull,""] || _parameters in ["",[]]) exitWith {};
...
[_target,_parameters] remoteExecCall [QUOTE(FUNC(add)),[0,-2] select isDedicated,_reID];